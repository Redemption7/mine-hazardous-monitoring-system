...
<nav class="relative container mx-auto p-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="hidden md:flex space-x-6">
            ...
            <a href="<?php echo e(route('register')); ?>" class="hover:text-darkGrayishBlue">Register</a>
        </div>
        <!-- Button -->
...
<?php /**PATH /Users/redemptionnhunzvi/Documents/GitHub/mine-hazardous-monitoring-system/dashboard-website/resources/views/welcome.blade.php ENDPATH**/ ?>